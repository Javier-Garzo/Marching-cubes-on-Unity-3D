...
// Shader from Chaser324: https://github.com/Chaser324/unity-wireframe/blob/master/Assets/Wireframe/Shaders/WireframeShaded-Unlit.shader

Shader "Custom/Wireframes/WireframeNormal"
{
	Properties
	{
